...
public class JalaliCalendarShamsiToMiladi {
   ...
   * Today Jalali Date
   */
  public JalaliCalendarShamsiToMiladi() {
   ...
   */
  public JalaliCalendarShamsiToMiladi(int year, int month, int day) {
    set(year, month, day);
  }
   ...
   */
  public JalaliCalendarShamsiToMiladi(GregorianCalendar gc){
    fromGregorian(gc);
  }
   ...
   */
  public JalaliCalendarShamsiToMiladi(LocalDate ld) {
   ...
   */
  public JalaliCalendarShamsiToMiladi(Date date) {
   ...
   */
  public JalaliCalendarShamsiToMiladi getYesterday() {
   ...
   */
  public JalaliCalendarShamsiToMiladi getTomorrow() {
    return getDateByDiff(1);
  }
   ...
   */
  public JalaliCalendarShamsiToMiladi getDateByDiff(int diff) {
    GregorianCalendar gc = toGregorian();
    gc.add(Calendar.DAY_OF_MONTH, diff);
    return new JalaliCalendarShamsiToMiladi(gc);
  }
  ...
  public boolean equals(Object o) {
    ...
    JalaliCalendarShamsiToMiladi that = (JalaliCalendarShamsiToMiladi) o;
  ...
  private void fromJulianDay(int JulianDayNumber) {
    ...
    GregorianCalendar gregorianFirstFarvardin = new JalaliCalendarShamsiToMiladi(jalaliYear, 1, 1).getGregorianFirstFarvardin();
